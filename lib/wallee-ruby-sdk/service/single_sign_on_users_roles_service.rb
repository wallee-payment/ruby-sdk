...
module WalleeRubySdk
  class SingleSignOnUsersRolesService
    ...
    # @return [nil]
    def delete_single_sign_on_users_user_id_account_roles(user_id, role_id, account, opts = {})
      delete_single_sign_on_users_user_id_account_roles_with_http_info(user_id, role_id, account, opts)
      nil
    end
    ...
    def delete_single_sign_on_users_user_id_account_roles_with_http_info(user_id, role_id, account, opts = {})
    ...
    def get_single_sign_on_users_user_id_account_roles(user_id, account, opts = {})
      data, _status_code, _headers = get_single_sign_on_users_user_id_account_roles_with_http_info(user_id, account, opts)
      data
    end
    ...
    def get_single_sign_on_users_user_id_account_roles_with_http_info(user_id, account, opts = {})
      if @api_client.config.debugging
    ...
    def post_single_sign_on_users_user_id_account_roles(user_id, role_id, account, opts = {})
      data, _status_code, _headers = post_single_sign_on_users_user_id_account_roles_with_http_info(user_id, role_id, account, opts)
      data
    end
    ...
    def post_single_sign_on_users_user_id_account_roles_with_http_info(user_id, role_id, account, opts = {})
      if @api_client.config.debugging
