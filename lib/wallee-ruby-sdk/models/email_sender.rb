...
module Wallee
  ...
  class EmailSender
    ...
    def self.swagger_types
      {
        ...
        :'sender_name' => :'DatabaseTranslatedString',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultSender')
        self.default_sender = attributes[:'defaultSender']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          default_sender == o.default_sender &&
          id == o.id &&
    ...
    def hash
      [default_sender, id, linked_space_id, planned_purge_date, sender_address, sender_name, state, type, version].hash
    end
