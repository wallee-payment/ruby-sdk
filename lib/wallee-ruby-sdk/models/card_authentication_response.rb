...
module WalleeRubySdk
  class CardAuthenticationResponse
    ...
    def self.all_vars
      @all_vars ||= [FULLY_AUTHENTICATED, AUTHENTICATION_NOT_REQUIRED, NOT_ENROLLED, ENROLLMENT_ERROR, AUTHENTICATION_ERROR].freeze
    end
    ...
    def build_from_hash(value)
      return value if CardAuthenticationResponse.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CardAuthenticationResponse"
    end
  end
end
