...
module WalleeRubySdk
  class RecurringIndicator
    ...
    def self.all_vars
      @all_vars ||= [REGULAR_TRANSACTION, INITIAL_RECURRING_TRANSACTION, MERCHANT_INITIATED_RECURRING_TRANSACTION, CUSTOMER_INITIATED_RECURRING_TRANSACTION].freeze
    end
    ...
    def build_from_hash(value)
      return value if RecurringIndicator.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #RecurringIndicator"
    end
  end
end
