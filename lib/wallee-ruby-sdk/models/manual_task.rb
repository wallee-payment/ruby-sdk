  ...
  class ManualTask
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'Integer',
        :'actions' => :'Array<ManualTaskAction>',
        :'created_on' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `WalleeRubySdk::ManualTask` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `WalleeRubySdk::ManualTask`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'context_entity_id')
        self.context_entity_id = attributes[:'context_entity_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          context_entity_id == o.context_entity_id &&
    ...
    def hash
      [linked_space_id, context_entity_id, planned_purge_date, expires_on, id, state, type, actions, created_on].hash
    end
