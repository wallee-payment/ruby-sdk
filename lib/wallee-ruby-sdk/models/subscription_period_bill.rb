  ...
  class SubscriptionPeriodBill
    ...
    def self.openapi_types
      {
        ...
        :'subscription_version' => :'SubscriptionVersion',
        :'effective_period_end_date' => :'Time',
        :'language' => :'String',
        :'id' => :'Integer',
        :'state' => :'SubscriptionPeriodBillState',
        :'created_on' => :'Time',
        :'planned_period_end_date' => :'Time',
        :'version' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `WalleeRubySdk::SubscriptionPeriodBill` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `WalleeRubySdk::SubscriptionPeriodBill`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'effective_period_end_date')
        self.effective_period_end_date = attributes[:'effective_period_end_date']
      end
      ...
      if attributes.key?(:'planned_period_end_date')
        self.planned_period_end_date = attributes[:'planned_period_end_date']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          effective_period_end_date == o.effective_period_end_date &&
          language == o.language &&
          id == o.id &&
          state == o.state &&
          created_on == o.created_on &&
          planned_period_end_date == o.planned_period_end_date &&
          version == o.version
    end
    ...
    def hash
      [linked_space_id, period_start_date, planned_purge_date, subscription_version, effective_period_end_date, language, id, state, created_on, planned_period_end_date, version].hash
