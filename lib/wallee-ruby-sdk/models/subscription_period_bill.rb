...
module Wallee
  ...
  class SubscriptionPeriodBill
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'effectivePeriodEndDate')
        self.effective_period_end_date = attributes[:'effectivePeriodEndDate']
      end
      ...
      if attributes.has_key?(:'plannedPeriodEndDate')
        self.planned_period_end_date = attributes[:'plannedPeriodEndDate']
      end
    ...
    def hash
      [created_on, effective_period_end_date, id, language, linked_space_id, period_start_date, planned_period_end_date, planned_purge_date, state, subscription_version, version].hash
    end
