  ...
  class SubmittedAnalyticsQueryExecution
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `WalleeRubySdk::SubmittedAnalyticsQueryExecution` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `WalleeRubySdk::SubmittedAnalyticsQueryExecution`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_billed_execution_time_ms')
        self.total_billed_execution_time_ms = attributes[:'total_billed_execution_time_ms']
      end
      ...
      if attributes.key?(:'download_requests')
        self.download_requests = attributes[:'download_requests']
      end

      if attributes.key?(:'original_query')
        self.original_query = attributes[:'original_query']
      end

      if attributes.key?(:'scanned_bytes')
        self.scanned_bytes = attributes[:'scanned_bytes']
      end

      if attributes.key?(:'portal_query_token')
        self.portal_query_token = attributes[:'portal_query_token']
      end

      if attributes.key?(:'result_file_bytes')
        self.result_file_bytes = attributes[:'result_file_bytes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          download_requests == o.download_requests &&
          original_query == o.original_query &&
          scanned_bytes == o.scanned_bytes &&
          portal_query_token == o.portal_query_token &&
          result_file_bytes == o.result_file_bytes &&
          status == o.status
    end
