...
module Wallee
  ...
  class SpaceAddressSetter
    ...
    def hash
      [city, country, dependent_locality, email_address, family_name, given_name, organization_name, post_code, postal_state, sales_tax_number, salutation, sorting_code, street].hash
    end
