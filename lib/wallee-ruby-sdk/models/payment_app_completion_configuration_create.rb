...
module Wallee
  ...
  class PaymentAppCompletionConfigurationCreate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'completionEndpoint')
        self.completion_endpoint = attributes[:'completionEndpoint']
      end

      if attributes.has_key?(:'completionTimeoutInMinutes')
        self.completion_timeout_in_minutes = attributes[:'completionTimeoutInMinutes']
      end

      if attributes.has_key?(:'maximalCompletionDelayInDays')
        self.maximal_completion_delay_in_days = attributes[:'maximalCompletionDelayInDays']
      end

      if attributes.has_key?(:'multipleCompletionsSupported')
        self.multiple_completions_supported = attributes[:'multipleCompletionsSupported']
      end

      if attributes.has_key?(:'voidEndpoint')
        self.void_endpoint = attributes[:'voidEndpoint']
      end
    end
    ...
    def hash
      [completion_endpoint, completion_timeout_in_minutes, maximal_completion_delay_in_days, multiple_completions_supported, void_endpoint].hash
    end
