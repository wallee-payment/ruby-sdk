...
module WalleeRubySdk
  class PaymentAppCompletionConfigurationCreate
    ...
    def self.openapi_types
      {
        :'multiple_completions_supported' => :'Boolean',
        :'maximal_completion_delay_in_days' => :'Integer',
        :'completion_endpoint' => :'String',
        :'completion_timeout_in_minutes' => :'Integer',
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `WalleeRubySdk::PaymentAppCompletionConfigurationCreate` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        unless self.class.attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `WalleeRubySdk::PaymentAppCompletionConfigurationCreate`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'multiple_completions_supported')
        self.multiple_completions_supported = attributes[:'multiple_completions_supported']
      end

      if attributes.key?(:'maximal_completion_delay_in_days')
        self.maximal_completion_delay_in_days = attributes[:'maximal_completion_delay_in_days']
      end

      if attributes.key?(:'completion_endpoint')
        self.completion_endpoint = attributes[:'completion_endpoint']
      end

      if attributes.key?(:'completion_timeout_in_minutes')
        self.completion_timeout_in_minutes = attributes[:'completion_timeout_in_minutes']
      end

      if attributes.key?(:'void_endpoint')
        self.void_endpoint = attributes[:'void_endpoint']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          multiple_completions_supported == o.multiple_completions_supported &&
          maximal_completion_delay_in_days == o.maximal_completion_delay_in_days &&
          completion_endpoint == o.completion_endpoint &&
          completion_timeout_in_minutes == o.completion_timeout_in_minutes &&
          void_endpoint == o.void_endpoint
    end
    ...
    def hash
      [multiple_completions_supported, maximal_completion_delay_in_days, completion_endpoint, completion_timeout_in_minutes, void_endpoint].hash
