...
module Wallee
  ...
  class InstallmentCalculatedPlan
    ...
    def self.swagger_types
      {
        ...
        :'payment_method_configurations' => :'Array<PaymentMethodConfiguration>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'slices')
        if (value = attributes[:'slices']).is_a?(Array)
          self.slices = value
        end
      end
    ...
    def hash
      [configuration, payment_method_configurations, slices, total_amount, transaction].hash
    end
