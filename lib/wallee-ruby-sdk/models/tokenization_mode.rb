...
module WalleeRubySdk
  class TokenizationMode
    ...
    def self.all_vars
      @all_vars ||= [FORCE_UPDATE, FORCE_CREATION, FORCE_CREATION_WITH_ONE_CLICK_PAYMENT, ALLOW_ONE_CLICK_PAYMENT].freeze
    end
    ...
    def build_from_hash(value)
      return value if TokenizationMode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #TokenizationMode"
    end
  end
end
