...
module Wallee
  ...
  class PaymentAppConnectorCreationRequest
    ...
    attr_accessor :authorization_timeout_in_minutes
    ...
    attr_accessor :processor_external_id
    ...
    def self.swagger_types
      {
        :'authorization_timeout_in_minutes' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'authorizationTimeoutInMinutes')
        self.authorization_timeout_in_minutes = attributes[:'authorizationTimeoutInMinutes']
      end
      ...
      if attributes.has_key?(:'processorExternalId')
        self.processor_external_id = attributes[:'processorExternalId']
      end
    ...
    def list_invalid_properties
      ...
      if @authorization_timeout_in_minutes.nil?
        invalid_properties.push('invalid value for "authorization_timeout_in_minutes", authorization_timeout_in_minutes cannot be nil.')
      end
      ...
      if @payment_page_endpoint.nil?
        invalid_properties.push('invalid value for "payment_page_endpoint", payment_page_endpoint cannot be nil.')
      end

      if @processor_external_id.nil?
        invalid_properties.push('invalid value for "processor_external_id", processor_external_id cannot be nil.')
      end

      if @processor_external_id.to_s.length > 40
        invalid_properties.push('invalid value for "processor_external_id", the character length must be smaller than or equal to 40.')
      end

      if @processor_external_id.to_s.length < 1
        invalid_properties.push('invalid value for "processor_external_id", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      return false if @authorization_timeout_in_minutes.nil?
      ...
      return false if @payment_page_endpoint.nil?
      return false if @processor_external_id.nil?
      return false if @processor_external_id.to_s.length > 40
      return false if @processor_external_id.to_s.length < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] processor_external_id Value to be assigned
    def processor_external_id=(processor_external_id)
      if processor_external_id.nil?
        fail ArgumentError, 'processor_external_id cannot be nil'
      end

      if processor_external_id.to_s.length > 40
        fail ArgumentError, 'invalid value for "processor_external_id", the character length must be smaller than or equal to 40.'
      end

      if processor_external_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "processor_external_id", the character length must be great than or equal to 1.'
      end

      @processor_external_id = processor_external_id
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          authorization_timeout_in_minutes == o.authorization_timeout_in_minutes &&
          completion_configuration == o.completion_configuration &&
          connector == o.connector &&
          external_id == o.external_id &&
          name == o.name &&
          payment_page_endpoint == o.payment_page_endpoint &&
          processor_external_id == o.processor_external_id &&
    ...
    def hash
      [authorization_timeout_in_minutes, completion_configuration, connector, external_id, name, payment_page_endpoint, processor_external_id, refund_configuration].hash
    end
