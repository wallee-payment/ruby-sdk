...
module Wallee
  ...
  class CustomerAddress
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultAddress')
        self.default_address = attributes[:'defaultAddress']
      end
    ...
    def hash
      [address, address_type, created_on, customer, default_address, id, linked_space_id, version].hash
    end
