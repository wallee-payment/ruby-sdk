...
module Wallee
  ...
  class ShopifySubscriptionVersionItem
    ...
    def self.swagger_types
      {
        ...
        :'product' => :'Integer',
        :'quantity' => :'Float',
        :'tax_lines' => :'Array<ShopifyTaxLine>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'priceStrategy')
        self.price_strategy = attributes[:'priceStrategy']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          price_strategy == o.price_strategy &&
          product == o.product &&
          quantity == o.quantity &&
    ...
    def hash
      [price_including_tax, price_strategy, product, quantity, tax_lines].hash
    end
