...
module Wallee
  ...
  class InstallmentPayment
    ...
    # 
    attr_accessor :plan_configuration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'planConfiguration')
        self.plan_configuration = attributes[:'planConfiguration']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          plan_configuration == o.plan_configuration &&
    ...
    def hash
      [created_on, id, initial_transaction, line_items, linked_space_id, plan_configuration, planned_purge_date, state, version].hash
    end
