...
module Wallee
  ...
  class RefundRecoveryBankTransaction
    ...
    def hash
      [bank_transaction, id, language, line_items, linked_space_id, linked_transaction, refund, refund_currency_amount, refund_currency_value_amount, space_view_id, version].hash
    end
