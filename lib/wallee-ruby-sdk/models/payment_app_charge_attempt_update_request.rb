...
module Wallee
  ...
  class PaymentAppChargeAttemptUpdateRequest
    ...
    attr_accessor :charge_attempt_id
    ...
    attr_accessor :failure_reason_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chargeAttemptId')
        self.charge_attempt_id = attributes[:'chargeAttemptId']
      end

      if attributes.has_key?(:'endUserFailureMessage')
        self.end_user_failure_message = attributes[:'endUserFailureMessage']
      end

      if attributes.has_key?(:'failureReasonId')
        self.failure_reason_id = attributes[:'failureReasonId']
      end
      ...
      if attributes.has_key?(:'targetState')
        self.target_state = attributes[:'targetState']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          charge_attempt_id == o.charge_attempt_id &&
          end_user_failure_message == o.end_user_failure_message &&
          failure_reason_id == o.failure_reason_id &&
    ...
    def hash
      [charge_attempt_id, end_user_failure_message, failure_reason_id, reference, target_state].hash
    end
