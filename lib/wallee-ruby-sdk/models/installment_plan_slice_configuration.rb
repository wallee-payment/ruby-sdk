...
module Wallee
  ...
  class InstallmentPlanSliceConfiguration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'proportion')
        self.proportion = attributes[:'proportion']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          line_item_title == o.line_item_title &&
    ...
    def hash
      [id, line_item_title, linked_space_id, period, plan, planned_purge_date, priority, proportion, state, version].hash
    end
