...
module WalleeRubySdk
  class PaymentConnectorConfigurationCreate
    ...
    def self.openapi_types
      {
        ...
        :'processor_configuration' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'payment_method_configuration')
        ...
        self.payment_method_configuration = nil
      end
      ...
      if attributes.key?(:'processor_configuration')
        ...
        self.processor_configuration = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @payment_method_configuration.nil?
        invalid_properties.push('invalid value for "payment_method_configuration", payment_method_configuration cannot be nil.')
      end
      ...
      if @processor_configuration.nil?
        invalid_properties.push('invalid value for "processor_configuration", processor_configuration cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @payment_method_configuration.nil?
      return false if @connector.nil?
      return false if @state.nil?
      return false if @processor_configuration.nil?
      true
    end
